...
def show_open_data_card(col):
    ...
    with col:
        ...
        fig = px.bar(df, x="CampaignTotal", y="CandidateName", orientation='h',
                     title="Top 5 Campaign Funds 2020",
...
def show_budget_card(col):
    ...
    with col:
        ...
        st.markdown(header_style, unsafe_allow_html=True)
        # Create a card layout with a blue header
        create_card_header("HSPLS Digital Literacy Budget", "https://raw.githubusercontent.com/datjandra/Team-Pu-u-Kukui/refs/heads/main/images/money-dollar-circle-line.png")
        ...
        st.markdown("""
                ...
                <div class="card-footer">
                    <span class="card-footer-text">More Detailed Analysis</span>
